...
login(driver);
		...
		driver.findElement(By.xpath("/html/body/form/table/tbody/tr[7]/td[4]/a[1]")).click();
		Thread.sleep(500);
		driver.findElement(By.name("NAME")).clear();
		driver.findElement(By.name("NAME")).sendKeys("Labiba");
		driver.findElement(By.name("summary")).clear();
		driver.findElement(By.name("summary")).sendKeys("Good Me");
